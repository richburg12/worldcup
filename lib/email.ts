...
export async function sendVerificationEmail(params: {
  ...
  const subject = 'Confirm your World Cup bracket entry';

  const text = [
    `Hi ${params.displayName},`,
    '',
    'Thanks for entering the World Cup bracket contest. Confirm your entry to get on the leaderboard:',
    link,
    '',
    "If you didn't enter, you can ignore this email.",
    '',
    'Good luck! 🏆',
  ].join('\n');
  ...
  <div style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:14px;padding:28px 26px;border:1px solid #e7e5e4;">
    <h1 style="margin:0 0 14px;font-size:20px;color:#1c1917;">You're one click away 🏆</h1>
    <p style="margin:0 0 12px;font-size:15px;line-height:1.5;">Hi ${name},</p>
    <p style="margin:0 0 20px;font-size:15px;line-height:1.5;">Thanks for entering the World Cup bracket contest. Confirm your entry to lock it onto the leaderboard.</p>
